...
var ClientesListComponent = (function () {
    function ClientesListComponent(service, router) {
        this.service = service;
        this.router = router;
    }
    ClientesListComponent.prototype.routerOnActivate = function (curr) {
        this.selectedId = +curr.getParam('id');
    };
    ClientesListComponent.prototype.isSelected = function (cliente) { return cliente.id === this.selectedId; };
    ...
    ClientesListComponent.prototype.onSelect = function (cliente) {
...
exports.ClientesListComponent = ClientesListComponent;
//# sourceMappingURL=/Users/LeonardoAlmeida/WebstormProjects/imobapp/app/componentes/cadastro/clientes-list.component.js.map